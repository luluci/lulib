...
namespace lulib { namespace win32api { namespace window_detail { namespace common_control {
	...
	namespace detail {
		// ロード: Version 4.71 以降： ページャーコントロール
		typedef init_common_control_ex<ICC_PAGESCROLLER_CLASS> init_pagescroller_classes_impl;
	}

	typedef lulib::singleton<detail::init_pagescroller_classes_impl> init_pagescroller_classes;
